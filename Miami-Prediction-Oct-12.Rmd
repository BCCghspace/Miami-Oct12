...
```{r Table 1: TABLE summary stats, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 1: Correlation Matrix, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Fig 2.1-2.4: 4 SCATTERPLOT home price correlation, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
housesKnown <- houses %>%    
  filter(.,toPredict == 0)
...
```{r Fig 3: MAP Sale Price, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Fig 4.1-4.5: MAP 3 Independent Variables, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Table 2: TABLE Training Set lm, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
```{r Figure 5.1-5.2 Test the regression, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
```{r Table 3: TABLE of MAE and MAPE for single k- fold test set, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
#AD: we also need standard deviation and MAPE
...
reg.cv.rs.min %>%                     #AD: knitting stops here because it can't find where this was made
  gather(Variable, Value) %>%
  filter(Variable == "Resample" | Variable == "MAE" | Variable == "MAPE") %>%
  group_by(Variable) %>%
...
```{r Fig 6.1: HISTOGRAM results of cross-validation tests, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 7.1: MAP of residuals for test set, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 8.1: Spatial lag, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 9.1:Morans I, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Table 4: Neighborhood Regression, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
```{r Fig 10.1:PLOT predicted prices as a function of observed prices, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 11.1: map of predicted values, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
#876 rows
...
```{r Figure 12.1: Test set predictions, provide a map of MAPE by neighborhood, fig.height=5, fig.width=8, message=FALSE, warning=FALSE, include=TRUE}
...
```{r Figure 13.1: Scatterplot of MAPE by neighborhood as a function of mean price by neighborhood, message=FALSE, warning=FALSE, include=TRUE}
...
Table 5 and 6 confirm that this model applies slightly differently for different demographics. In Majority non-white neighborhoods, MAPE is 30% higher than in majority white neighborhoods. Similarly, MAPE is 27% higher in low income neighborhoods than in high income ones. 
